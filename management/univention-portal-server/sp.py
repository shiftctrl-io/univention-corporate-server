...
bases = ['%s://%s/portal/saml' % (scheme, addr) for addr in addresses for scheme in ('https', 'http')]
CONFIG = {
	"entityid": "https://%s/univention/portal" % (fqdn,),
	"name_form": NAME_FORMAT_UNSPECIFIED,
	"description": "Univention Portal SAML2.0 Service Provider",
	"service": {
		"sp": {
