...
define([
	...
	var pageConf = {
		...
		widgets: [{
			...
			type: Text,
			name: 'text3',
			content: _('<p>Details about the activation of a UCS license can be found in the <a href="https://docs.software-univention.de/manual.html#central:license" target="_blank">UCS manual</a>.</p>', {
