			...
			lang.mixin(this, {
				pages: [{
					...
					helpText: _('Several network types can be chosen.') +
						...
						_('Further information can be found in the <a href="https://docs.software-univention.de/manual.html#computers:networkcomplex" target="_blank">UCS documentation</a>.'),
					widgets: [{
						// required to rename
						name: 'original_name',
						type: TextBox,
